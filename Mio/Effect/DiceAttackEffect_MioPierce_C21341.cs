...
{
    public class DiceAttackEffect_MioPierce_C21341 : DiceAttackEffect
    {
        ...
        public override void Initialize(BattleUnitView self, BattleUnitView target, float destroyTime)
        {
            ...
            DiceEffectUtil.InitializeEffect(TheColorsModParameters.Path, 0.725f, 0.31f, true, this, self, target);
        }
