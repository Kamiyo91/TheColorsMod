...
{
    public class DiceAttackEffect_MioSlash_C21341 : DiceAttackEffect
    {
        ...
        public override void Initialize(BattleUnitView self, BattleUnitView target, float destroyTime)
        {
            ...
            DiceEffectUtil.InitializeEffect(TheColorsModParameters.Path, 0.7f, 0.27f, true, this, self, target);
        }
