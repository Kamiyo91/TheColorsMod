...
{
    public class FarAreaEffect_MioAbyssalDiamond_C21341 : FarAreaEffect
    {
                                    ...
                                    switch (_motionCount)
                                    {
                                        case 0:
                                        {
                                            audioClip = UnitUtil.GetSound(
                                                CustomMapHandler.GetCMU(TheColorsModParameters.PackageId),
                                                "Purple_Stab_Stab2", true);
                                            detail = ActionDetail.Penetrate;
                                            var componentType = ModParameters.CustomEffects["MioPierce_C21341"];
                                            var diceAttackEffect =
                                                new GameObject("MioPierce_C21341").AddComponent(componentType) as
                                                    DiceAttackEffect;
                                        ...
                                        case 1:
                                        {
                                            ...
                                            var componentType = ModParameters.CustomEffects["MioSlash_C21341"];
                                            var diceAttackEffect =
                                                new GameObject("MioSlash_C21341").AddComponent(componentType) as
                                                    DiceAttackEffect;
                                            if (diceAttackEffect == null) break;
                                            diceAttackEffect.Initialize(_self.view, victimInfo2.unitModel.view, 0.5f);
                                            diceAttackEffect.SetScale(1f);
                                        ...
                                        case 2:
                                        {
                                            ...
                                            var componentType = ModParameters.CustomEffects["MioHit_C21341"];
                                            var diceAttackEffect =
                                                new GameObject("MioHit_C21341").AddComponent(componentType) as
                                                    DiceAttackEffect;
                                            if (diceAttackEffect == null) break;
                                            diceAttackEffect.Initialize(_self.view, victimInfo2.unitModel.view, 0.5f);
                                            diceAttackEffect.SetScale(1f);
