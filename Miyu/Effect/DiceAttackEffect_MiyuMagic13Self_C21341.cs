...
{
    public class DiceAttackEffect_MiyuMagic13Self_C21341 : DiceAttackEffect
    {
        ...
        public override void Initialize(BattleUnitView self, BattleUnitView target, float destroyTime)
        {
            ...
            DiceEffectUtil.InitializeEffect(TheColorsModParameters.Path, 0.50f, 0.20f, false, this, self, target);
        }
