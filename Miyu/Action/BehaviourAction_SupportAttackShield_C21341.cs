...
{
    public class BehaviourAction_SupportAttackShield_C21341 : BehaviourActionBase
    {
        ...
        private List<RencounterManager.MovingAction> SetAttacksPlayer()
        {
            ...
            {
                CreateAttackAction(ActionDetail.S4, 0.5f, "MiyuMagic2_C21341", EffectTiming.NOT_PRINT, EffectTiming.PRE,
