...
{
    public class BehaviourAction_SupportAttackBuff_C21341 : BehaviourActionBase
    {
        ...
        private List<RencounterManager.MovingAction> SetAttacksPlayer()
        {
            ...
            {
                CreateAttackAction(ActionDetail.S8, 0.5f, "MiyuMagic12_C21341", EffectTiming.NOT_PRINT,
                    EffectTiming.PRE,
