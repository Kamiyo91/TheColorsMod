...
{
    public class DiceAttackEffect_KamiyoSlashForgotten_C21341 : DiceAttackEffect
    {
        ...
        public override void Initialize(BattleUnitView self, BattleUnitView target, float destroyTime)
        {
            ...
            DiceEffectUtil.InitializeEffect(TheColorsModParameters.Path, 0.55f, 0.15f, true, this, self, target);
        }
