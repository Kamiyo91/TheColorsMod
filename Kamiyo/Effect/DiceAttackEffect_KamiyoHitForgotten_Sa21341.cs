...
{
    public class DiceAttackEffect_KamiyoHitForgotten_C21341 : DiceAttackEffect
    {
        ...
        public override void Initialize(BattleUnitView self, BattleUnitView target, float destroyTime)
        {
            ...
            DiceEffectUtil.InitializeEffect(TheColorsModParameters.Path, 0.54f, 0.32f, true, this, self, target);
        }
