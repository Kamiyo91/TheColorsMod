...
{
    public class DiceAttackEffect_SaeSlash_C21341 : DiceAttackEffect
    {
        ...
        public override void Initialize(BattleUnitView self, BattleUnitView target, float destroyTime)
        {
            ...
            DiceEffectUtil.InitializeEffect(TheColorsModParameters.Path, 0.5f, 0.2f, true, this, self, target);
        }
