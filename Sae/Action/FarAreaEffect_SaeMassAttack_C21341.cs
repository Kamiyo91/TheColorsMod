...
{
    public class FarAreaEffect_SaeMassAttack_C21341 : FarAreaEffect
    {
        public enum Phase
        {
            Start,
        ...
        private readonly AudioClip _soundS1 = UnitUtil.GetSound(
            CustomMapHandler.GetCMU(TheColorsModParameters.PackageId),
            "Purple_Slash_Hori", true);

        private readonly AudioClip _soundS2 = UnitUtil.GetSound(
            CustomMapHandler.GetCMU(TheColorsModParameters.PackageId),
            "Purple_Stab_Stab2", true);

        private readonly AudioClip _soundS3 = UnitUtil.GetSound(
            CustomMapHandler.GetCMU(TheColorsModParameters.PackageId),
